---
name: wacli
description: Send WhatsApp messages or search/sync history via the wacli CLI.
...
Do NOT use `wacli` for normal user chats; NyxClaw routes WhatsApp conversations automatically.
