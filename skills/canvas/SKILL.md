...
- **loopback**: `http://127.0.0.1:18793/__nyxclaw__/canvas/<file>.html`
- **lan/tailnet/auto**: `http://<hostname>:18793/__nyxclaw__/canvas/<file>.html`
...
1. Check server bind: `cat ~/.nyxclaw/nyxclaw.json | jq '.gateway.bind'`
2. Check what port canvas is on: `lsof -i :18793`
3. Test URL directly: `curl http://<hostname>:18793/__nyxclaw__/canvas/<file>.html`
