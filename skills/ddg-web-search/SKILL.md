---
name: ddg-search
description: Search the internet for information, news, and research. Web search without an API key using DuckDuckGo Lite via web_fetch. Zero dependencies.
---
...
> **GenosOS:** All HTTP requests use `web_fetch({ url, method, headers, body })`. No external dependencies required.
