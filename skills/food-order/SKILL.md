---
name: food-order
description: Reorder Foodora orders and track ETA/status with ordercli.
...
Never confirm without explicit user approval. Triggers: order food, reorder, track ETA.
